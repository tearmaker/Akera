define(['infomanager', 'bubble', 'renderer', 'map', 'animation', 'sprite',
        ...
        'mobs', 'exceptions', 'config', 'guild', '../../shared/js/gametypes'], //SRR
    function (InfoManager, BubbleManager, Renderer, Map, Animation, Sprite, AnimatedTile,
        ...
        var Game = Class.extend({
            init: function (app) {
                ...
                // sprites
                this.spriteNames = ["hand", "sword", "loot", "target", "talk", "sparks", "shadow16",
                                    "rat", "rat2", "skeleton", "skeleton2", "spectre", "boss", "deathknight","ogre", "crab", "snake", "eye", "bat", "goblin", "wizard", 
                                    "villager01", "villager02", "villager03", "villager04", "villager05", "villager06", "villager07", "villager08", "villager09", "villager10",
                                    "rick", "malade01", "trap1",
                                    "lore01", "lore02",
                                    "quester01", "quester02", "quester03", "quester04", "quester05",
                                    "gite01", "gite02", "gite03", "gite04", "gite05", "gite06", "gite07", "gite08", "gite09", "gite10",
                                    "clotharmor", "clotharmor2", "leatherarmor", "leatherarmor2", "mailarmor", "mailarmor2", "platearmor", "platearmor2", "redarmor", "redarmor2", "goldenarmor", "goldenarmor2", "firefox",
                                    "sword1", "axe", "sword2", "redsword", "bluesword", "goldensword", "morningstar",
                                    "death", "chest",  "item-sword2", "item-axe", "item-redsword", "item-bluesword", "item-goldensword", "item-leatherarmor", "item-mailarmor", "item-platearmor", "item-redarmor", "item-goldenarmor", "item-flask", "item-cake", "item-burger", "item-morningstar", "item-firepotion",
                                    "pface_boy1", "pface_boy2", "pface_boy3", "pface_girl1", "pface_girl2", "pface_girl3"];
                
                //removed
                //"guard", "king", "villager", "coder", "agent", "nyan", "octocat", "beachnpc", "forestnpc", 
            },
            ...
            initPlayer: function () {
                /*  if(this.storage.hasAlreadyPlayed() && this.storage.data.player) {  //SRR
            ...
            initShadows: function () {  //sprites good mais pas pface
                this.shadows = {};
            ...
            initHurtSprites: function () {
                ...
                Types.forEachArmorKind(function (kind, kindName) {
                    ...
                    if (kindName != 'firefox'){
                        self.sprites[kindName + '2'].createHurtSprite(); //SRR
                    }
                });
            },
            ...
            initAchievements: function () {         //SRR 
                ...
                this.achievements = {
                    MAIN_QUEST_1: {
                        id: 1,
                        name: "It Biguine",
                        desc: "Trouver la Capitaine"
                    },
                    MAIN_QUEST_2: {
                        id: 2, //SRR TEST
                        name: "Dé-monstr-ation",
                        desc: "Vaincre deux monstres",
                        hidden: true,
                        isCompleted: function () {
                            return (self.storage.hasUnlockedAchievement(1) && self.storage.getCrabCount() >= 2);
                        }
                    },
                    MAIN_QUEST_3: {
                        id: 3,
                        name: "Hippocrate",
                        desc: "Trouver le médecin",
                        hidden: true,
                        isCompleted: function () {
                            return self.storage.hasUnlockedAchievement(2);
                        }
                    },
                    MAIN_QUEST_4: {
                        id: 4,
                        name: "Ali Care",
                        desc: "Restituer les symptômes",
                        hidden: true,
                        isCompleted: function () {
                            return self.storage.hasUnlockedAchievement(3); // par bouton
                        }
                    },
                    MAIN_QUEST_5: {
                        id: 5,
                        name: "1001 pattes",
                        desc: "Trouver l'entomologiste",
                        hidden: true,
                        isCompleted: function () {
                            return self.storage.hasUnlockedAchievement(4);
                        }
                    },
                    MAIN_QUEST_6: {
                        id: 6,
                        name: "Like an aegypti",
                        desc: "Capturer 2 Aedes aegypti",
                        hidden: true,
                        isCompleted: function () {
                            return (self.storage.hasUnlockedAchievement(5) && self.storage.getRatCount() >= 5);
                        }
                    },
                    MAIN_QUEST_7: {
                        id: 7,
                        name: "Peer-review",
                        desc: "Trouver le scientifique",
                        hidden: true,
                        isCompleted: function () {
                            return self.storage.hasUnlockedAchievement(6);
                        }
                    },
                    MAIN_QUEST_8: {
                        id: 8,
                        name: "Dechiktaj",
                        desc: "Détruire des moustiques",
                        hidden: true,
                        isCompleted: function () {
                            return (self.storage.hasUnlockedAchievement(7) && self.storage.getRatCount() >= 5);
                        }
                    },
                    MAIN_QUEST_9: {
                        id: 9,
                        name: "L'oubliée",   //"Reste pas planté là, Power Plante, Fleur bleue ",
                        desc: "Trouver l'herboriste",
                        hidden: true,
                        isCompleted: function () {
                            return self.storage.hasUnlockedAchievement(8);
                        }
                    },
                    MAIN_QUEST_10: {
                        id: 10,
                        name: "Mis au vert",   //"Reste pas planté là, Power Plante, Fleur bleue ",
                        desc: "Rapporter une plante à Man",
                        hidden: true,
                        isCompleted: function () {
                            return (self.storage.hasUnlockedAchievement(9) && self.storage.hasDoneMiniQuest('plante_prise'));
                        }
                    },
                    MAIN_QUEST_11: { //Double quete : retour au Scientifique
                        id: 11,
                        name: "An ba fèy",
                        desc: "Protéger les malades",
                        hidden: true,
                        isCompleted: function () {
                            return (self.storage.hasUnlockedAchievement(10) && self.storage.hasDoneMiniQuest('protected'));
                        }
                    },
                    MAIN_QUEST_12: {
                        id: 12,
                        name: "In Rum Veritas",
                        desc: "Informer 3 citadins",
                        hidden: true,
                        isCompleted: function () {
                            return (self.storage.hasUnlockedAchievement(11) && self.storage.hasDoneMiniQuest('informed'));
                        }
                    },
                    MAIN_QUEST_13: {
                        id: 13,
                        name: "Ci-gîte", //Double quete : retour Entomo //Gite et couvert, Gi-Gîte
                        desc: "Détruire un gite",
                        hidden: true,
                        isCompleted: function () {
                            return self.storage.hasUnlockedAchievement(12) && self.storage.getGiteCount() >= 5;
                        }
                    },
                    MAIN_QUEST_14: {
                        id: 14,
                        name: "Un nouveau départ !",
                        desc: "Faire votre rapport final au scientifique",
                        hidden: true,
                        isCompleted: function () {
                            return self.storage.hasUnlockedAchievement(13);
                        }
                    },
                    MAIN_QUEST_TROLL: {
                        id: 15,
                        name: "Trolling",
                        desc: "Explorez le monde !",
                        hidden: true
                    },
                    COWARD: {
                        id: 16,
                    ...
                    FAYA_POTION: {
                        id: 18,
                        name: "Puissance",
                        desc: "Prendre la potion de puissance",
                        hidden: true
                    },
                    FOR_SCIENCE: {
                        id: 19,
                    ...
                    NINJA_LOOT: {
                        id: 20,
                        name: "Volè pa ni bénéfis",
                        desc: "Prendre l'objet d'un autre",
                        hidden: true
                    },
                    ...
                    INFO_1: {
                        ...
                        serious: true,
                        hidden: true,
                        desc: "Cyle moustique 1"
                    },
                    INFO_2: {
                        id: 22, //SRR TEST
                        name: "Info2",
                        desc: "Cyle moustique 2",
                        hidden: true,
                        serious: true,
                        isCompleted: function () {
                            return (self.storage.hasUnlockedAchievement(21));
                        }
                    },
                    INFO_3: {
                        id: 23,
                        name: "Info3",
                        desc: "Cyle moustique 3",
                        hidden: true,
                        serious: true,
                        isCompleted: function () {
                            return self.storage.hasUnlockedAchievement(22);
                        }
                    },
                    INFO_4: {
                        id: 24,
                        name: "Info4",
                        desc: "Cyle moustique 4",
                        hidden: true,
                        serious: true,
                        isCompleted: function () {
                            return self.storage.hasUnlockedAchievement(23);
                        }
                    }
                ...
                /* if(this.storage.hasAlreadyPlayed()) {
                     var achiev_list = this.player.getAchiev;
                     this.app.initUnlockedAchievements(this.player.achievements); 
                 } */
            },
            ...
            setSpriteScale: function (scale) { //au log et en changement de scale (sprites pas interface)
                var self = this;
            ...
            setServerOptions: function (host, port, username, userpw, email, gender, pface) { //SRR
                this.host = host;
                this.port = port;
            ...
            connect: function (action, started_callback) {
                ...
                this.client.onConnected(function () {
                    ...
                    if (action === 'create') {
                        self.player.gender = self.gender; //SRR
                        self.player.pface = self.pface;
                        self.client.sendCreate(self.player);
                    } else {
                        self.client.sendLogin(self.player);
                        
                        //SRR Check for sickness
                        if(self.storage.getPlayerIll() > 0){
                            self.player.setSickStats();
                            setTimeout(function(){
                                self.player.setCuredStats();
                                self.storage.setPlayerIll(0);
                            },30000);
                        }
                    }
                });
                ...
                this.client.onWelcome(function (id, name, x, y, hp, armor, weapon,
                    avatar, weaponAvatar, experience, gender, achievements, pface) { //SRR
                    log.info("Received player ID from server : " + id);
                    log.info("avatar client : " + avatar); //SRR
                    self.player.id = id;
                    self.playerId = id;
                    ...
                    self.player.setGender(gender); //SRR 
                    self.player.setAchievements(achievements); 
                    self.player.setPface(pface);
                    ...
                    if (!self.storage.hasAlreadyPlayed()) {
                        ...
                        self.showNotification("Bienvenue dans le monde d'Akera !");
                    } else {
                        self.showNotification("Content de vous revoir dans le monde d'Akera !");
                        //self.showNotification("Content de vous revoir ! Vous êtes niveau : " + self.player.level + ".");
                        self.storage.setPlayerName(name);

                        var list_achiev = self.player.achievements;
                        self.storage.initQuestRank(list_achiev); //sert à connaitre l'objectif du moment
                        self.app.initUnlockedAchievements(list_achiev); //initialise les achiev avec les données venu de la db SRR
                        self.storage.refreshAchievement(list_achiev); //change met à jour la mémoire locale
                    }
                    ...
                    self.player.onStep(function () {
                        ...
                        //Affichage des zones
                        var mzone = self.player.getMapzone();
                        if (self.player.gridY == 150) {
                            if(mzone != "ville_sud"){
                                self.showNotification("Vous êtes dans la : Ville Sud");
                            }
                            self.player.setMapzone("ville_sud");
                        }
                        
                        if ((self.player.gridY == 144) || (self.player.gridX == 19 && self.player.gridY == 123)) {
                            if(mzone != "caserne"){
                                self.showNotification("Vous êtes au : Plateau de la caserne");
                            }
                            self.player.setMapzone("caserne");
                        }
                        
                        //zones nulles
                        if (self.player.gridY == 149) {
                            self.player.setMapzone("nul");
                        }
                        ...
                        if ((self.player.gridX <= 85 && self.player.gridY <= 179 && self.player.gridY > 178) ||  (self.player.gridX <= 85 && self.player.gridY <= 266 && self.player.gridY > 265)) {
                           // self.tryUnlockingAchievement("MAIN_QUEST_3");
                        }
                    ...
                    self.player.onStopPathing(function (x, y) {
                        ...
                        if (self.player.target instanceof Npc) { //111
                            if(self.player.target.kind > 300){ //if lore
                                self.showLoreHint(self.player.target);
                            } else {
                    ...
                    self.client.onPVPChange(function (pvpFlag) {
                        ...
                        if (pvpFlag) {
                            self.showNotification("PVP est on.");
                        } else {
                            self.showNotification("PVP est off.");
                        }
                    });

                    self.player.onArmorLoot(function (armorName) {
                        //   log.info("======= armorName EST passe : " + armorName); //SRR PASSE
                        var gender = self.player.gender;
                        var armorgen = armorName + gender;
                        self.player.switchArmor(self.sprites[armorgen]); //SRR modifie l'apparence en fonction du genre
                            ...
                            try  {
                                if (entity.id !== self.playerId) {
                                    ...
                                    if (entity instanceof Npc) {  
                                        self.updateQuestMark(entity, self.storage.getQuestRank() );
                                    }
                                    ...
                                    if (entity instanceof Character) {
                                        ...
                                        entity.onDeath(function () {
                                            ...
                                            entity.isDying = true;
                                            entity.setSprite(self.sprites[entity instanceof Mobs.Rat ? "rat" : "death"]); //112
                 ...
                 /*   self.client.onGuildError(function (errorType, info) {
                    ...
                    self.client.onPlayerKillMob(function (kind, level, exp) {
                        ...
                        var prev_lvl = self.player.level;
                        ...
                        //self.showNotification("Expérience : " + self.player.experience + ". " + expPercentThisLevel.toFixed(0) + "% de ce niveau.");
                        if(level != prev_lvl) { //on lvl up
                            self.showNotification("Niveau supérieur !");
                            
                            if(prev_lvl == 1) {
                                self.app.toggleInstructions(1);
                            }
                        }
                        ...
                        if (mobName === 'boss') {
                            self.showNotification("Vous avez vaincu le BOSS !");
                        }
                        ...
                        if (kind === Types.Entities.RAT) {
                            ...
                            var count = self.storage.getRatCount();
                            
                            //Gestion du Karma
                            //if (self.storage.getPlayerIll() == 0) {
                            //if (!self.player.hasShadow())
                            
                            self.infoManager.addDamageInfo("+3 Global", self.player.x, self.player.y - 25, "good", 3000); 

                            
                            //Gestion des notifs
                            if(self.storage.getQuestRank() == 6 || self.storage.getQuestRank() == 8){
                                if (count <= 5 ) {
                                    var quest_notif = "Moustiques vaincus : " + count +"/5";
                                    self.showNotification(quest_notif);
                                    }
                            }
                            ...
                            self.infoManager.addDamageInfo("+" + mobExp + " exp", self.player.x, self.player.y - 25, "exp", 3000);
                        ...
                        if (kind === Types.Entities.CRAB) {
                            ...
                            if(self.storage.getQuestRank() == 2){
                                var count = self.storage.getCrabCount();
                                if (count <= 2 ) {
                                    var quest_notif = "Monstres vaincus : " + count +"/2";
                                    self.showNotification(quest_notif);
                                }
                            }
                        }
                    ...
                    self.client.onPlayerChangeHealth(function (points, isRegen) {
                        ...
                        player.forEachAttacker(function(attacker) {
                            if (attacker.kind == 2 ) { //si mordu par moustique
                                self.infoManager.addDamageInfo("-1 Global", player.x, player.y - 30, "bad");
                                
                                var sickRoll = Math.floor((Math.random() * 100) - self.globalQuestCounter);
                                
                                if (sickRoll > 50) {
                                    self.player.setSickStats();
                                    self.storage.setPlayerIll(1);
                                    setTimeout(function(){
                                        self.player.setCuredStats();
                                        self.storage.setPlayerIll(0);
                                    },10000);
                    ...
                    self.client.onPlayerEquipItem(function (playerId, itemKind, gender) {
                        var player = self.getEntityById(playerId),
                            itemName = Types.getKindAsString(itemKind),
                            avatar = itemName + gender;

                        if (player) {
                            if (Types.isArmor(itemKind)) {
                                player.setSprite(self.sprites[avatar]);
                    ...
                    self.client.onGlobalQuestChange(function (gq) { //SRR 
                            self.app.updateWorldBar(gq);
                            self.globalQuestCounter = gq;
                    });
            ...
            makeNpcTalk: function (npc) { //111
                var self = this;
                var msg;
                if (npc.currentAnimation.name.substr(0, 4) == 'sand' || npc.currentAnimation.name.substr(0, 3) == 'dry' || npc.currentAnimation.name == 'removed' ) { //Si déjà ensablé, pas de discussion
                    return;
                }
                ...
                if (npc) { //SRR
                    ...
                    $('#choices').empty(); //Supprime les choix préc
                    this.previousClickPosition = {};
                    
                    if (msg) {
                        $('#choices').removeAttr('hidden');
                        this.createBigBubble(npc, msg, this);
                        this.audioManager.playSound("npc");
                     
                    } else {
                        this.endDialog(npc);
                        if (npc.kind === Types.Entities.QUESTER01) { //Capitaine
                            this.tryUnlockingAchievement("MAIN_QUEST_1");
                            //setTimeout(function(){self.tryUnlockingAchievement("INFO_1");},2000);
                            //this.tryUnlockingAchievement("FOR_SCIENCE");
                            this.tryUnlockingAchievement("MAIN_QUEST_2");
                        } else if (npc.kind === Types.Entities.QUESTER02) {    //Medecin
                            this.tryUnlockingAchievement("MAIN_QUEST_3");
                            setTimeout(function(){self.tryUnlockingAchievement("INFO_1");},2000);
                            //this.tryUnlockingAchievement("MAIN_QUEST_4"); symptome des malades
                            //setTimeout(function(){self.tryUnlockingAchievement("INFO_2");},2000);
                        } else if (npc.kind === Types.Entities.QUESTER03) {   //Entomo
                            this.tryUnlockingAchievement("MAIN_QUEST_5");
                            this.tryUnlockingAchievement("MAIN_QUEST_6");
                            this.tryUnlockingAchievement("MAIN_QUEST_13");
                        } else if (npc.kind === Types.Entities.QUESTER04) { //Scientifique
                            this.tryUnlockingAchievement("MAIN_QUEST_7");
                            this.tryUnlockingAchievement("MAIN_QUEST_8");
                            this.tryUnlockingAchievement("MAIN_QUEST_11");
                            this.tryUnlockingAchievement("MAIN_QUEST_12");
                            this.tryUnlockingAchievement("MAIN_QUEST_14");
                            this.app.updateItemIcons();
                        } else if (npc.kind === Types.Entities.QUESTER05) { //ManLoubliee
                            if(this.storage.getQuestRank() == 10 && this.storage.hasDoneMiniQuest('plante_prise')){ //changement icone item
                                this.storage.setSlotItem(1,'item-repulsif'); 
                                this.app.updateItemIcons();
                            }
                            this.tryUnlockingAchievement("MAIN_QUEST_9");
                            this.tryUnlockingAchievement("MAIN_QUEST_10");
                        }
        ...
        showLoreHint: function(npc) {
            ...
            if(npc) {
                ...
                this.previousClickPosition = {};
                if(msg) {
                    this.createBubble(npc.id, msg[1]);
                ...
                if (this.started && this.player && !this.isZoning() && !this.isZoningTile(this.player.nextGridX, this.player.nextGridY) && !this.player.isDead && !this.hoveringCollidingTile && !this.hoveringPlateauTile) {
                    ...
                    if (entity instanceof Mob || (entity instanceof Player && entity !== this.player && this.player.pvpFlag && this.pvpFlag)) {
                        ...
                        if (this.player.isAdjacentNonDiagonal(entity) === false) {
                            ...
                            if (!this.player.disableKeyboardNpcTalk) {
                                if(entity.kind > 300) { //if lore
                                    this.showLoreHint(entity);
                                } else {
            ...
            createBigBubble: function (npc, message, game) { //SRR
                this.bubbleManager.bigCreate(npc, message, game, this.currentTime);
            },
        ...
        tryUnlockingAchievement: function (name) { // SRR
            var achievement = null;
            var last_main_quest = 16; //à changer aussi dans storage
            if (name in this.achievements) {
                ...
                if (achievement.isCompleted() && this.storage.unlockAchievement(achievement.id)) {
                    if (this.unlock_callback) {
                        ...
                        this.client.sendAchievement(achievement.id); //save BDD

                        if (achievement.id < last_main_quest) {
                            this.storage.setQuestRank(achievement.id + 1); //Permet de mettre à jour le but
                            this.storage.resetRatCount(); //Tempo bugggy
                            this.storage.resetCrabCount();
                            this.storage.resetGiteCount();
                        }
       ...
       updateQuestMark: function(entity, questrank) { //(id = 8+'x'+'y') 
           if(entity.itemKind){
               if(questrank < 3 && entity.kind === Types.Entities.QUESTER01){ // Briska
                   entity.setAnimation("quest_active", 600, 1, function () {});
               } else if (questrank >= 3 && questrank < 5 && entity.kind === Types.Entities.QUESTER02){ // Ker
                 entity.setAnimation("quest_active", 600, 1, function () {});
               } else if (questrank >= 5 && questrank < 7 && entity.kind === Types.Entities.QUESTER03){ // Entomo Marleen
                 entity.setAnimation("quest_active", 600, 1, function () {});
               } else if (questrank >= 7 && questrank < 9 && entity.kind === Types.Entities.QUESTER04){ //Makebaya
                 entity.setAnimation("quest_active", 600, 1, function () {});
               } else if (questrank >= 9 && questrank < 11 && entity.kind === Types.Entities.QUESTER05){ //Loubliée
                 entity.setAnimation("quest_active", 600, 1, function () {});
               } else if (questrank >= 11 && questrank < 13 && entity.kind === Types.Entities.QUESTER04){ //Makebaya
                 entity.setAnimation("quest_active", 600, 1, function () {});
               } else if (questrank == 13 && entity.kind === Types.Entities.QUESTER03){ //Entomo Marleen
                 entity.setAnimation("quest_active", 600, 1, function () {});
               } else if (questrank == 14 && entity.kind === Types.Entities.QUESTER04){ //Makebaya
                 entity.setAnimation("quest_active", 600, 1, function () {});
               }
            ...
            /*
                ...
                if (name in this.achievements) {
                    achievement = this.achievements[name];
                    var quest_rank = achievement.id;
                    var quest_next = quest_rank + 1;
                    var prec_done = true;

                    if (quest_rank > 1 && quest_rank < 11) { //SRR  11=nombre de quetes principales + 1 à modifier aussi plus bas
                        var quest_prec = quest_rank - 1;
                        prec_done = this.storage.hasUnlockedAchievement(quest_prec);
                    }
                    ...
                    if (prec_done) {
                        if (achievement.isCompleted() && this.storage.unlockAchievement(achievement.id)) {
                            if (this.unlock_callback) {
                                ...
                                if (quest_rank > 0 && quest_rank < 10) {
                                    this.storage.setQuestRank(quest_next);
                                }
                            }
                        }
                    }
            ...
            */
            ...
            slowCure:function () {  //112
                this.storage.DecrementIll();
                
                /*setTimeout(function () {
                    if(this.storage.getPlayerIll() > 0) {
                        this.slowCure();
                    }
                }, 3000);*/
            ...
            tryLootingItem: function (item) {
                try {
                    ...
                    if (item.kind === Types.Entities.FIREPOTION) {
                        this.tryUnlockingAchievement("FAYA_POTION");
